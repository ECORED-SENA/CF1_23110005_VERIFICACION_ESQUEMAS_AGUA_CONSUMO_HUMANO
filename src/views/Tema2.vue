  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5(data-aos="fade")
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Requisitos técnicos y normatividad
    .row.justify-content-center(data-aos="zoom-out-left")
      .col-lg-4
        img(src='@/assets/curso/tema2/img1.png', alt='Texto que describa la imagen')

      .col-lg-8
        p En este apartado se evalúan todos aquellos requisitos y normatividad para el sector de agua potable y residual en diferentes ámbitos de estudio. Un requisito técnico en este caso, puede entenderse como todos aquellos aspectos que deben cumplirse para alcanzar un proyecto específico; por otro lado, la normatividad se entiende como un conjunto de reglas de carácter obligatorio emanadas de una autoridad competente que sirven para regular las acciones sociales de una comunidad. 
        p Por lo anterior, la reglamentación ambiental propuesta en este tema, debe ser cumplida por el sector de agua potable y saneamiento básico con el fin de obtener buenas prácticas de ingeniería e, intentar prevenir al máximo los efectos negativos que pueden causarse al ambiente, asimismo, la regulación correcta en el sistema de acueducto, alcantarillado y aseo, pueden significar un impacto positivo en la sociedad y en el ambiente, provocando resolver las necesidades de abastecimiento de agua potable con calidad en la sociedad.
    .row.bg11.lag2
      .col-lg-4
      .col-lg-8
    ...
    .row.justify-content-center.bg4.mt-5(data-aos="zoom-in-left")
      .col-lg-8.mb-5
        ...
        LineaTiempoD.color-primario
          ...
          .row(numero="2" titulo="El manejo y disposición final adecuada de las aguas residuales y excretas")
            .col-md-2
              figure
          ...
          .row(numero="3" titulo="El manejo y disposición final adecuada de los residuos sólidos municipales")
            .col-md-2
              figure
      ...
      .col-lg-10.aaz.p-5
        figure
          .video(data-aos="zoom-out-up")
            iframe(width="560" height="315" src="https://www.youtube.com/embed/JlcWQ2GVqYk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
